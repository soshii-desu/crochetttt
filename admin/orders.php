        ...
        <main>
            <div class="header">
                ...
                <div class="right">
                    ...
                    <a href="cancelledorders.php" class="btn btn-danger">Cancelled
                    ...
                    <a href="packing.php" class="btn btn-warning">Packing<span style="color: white; font-weight:600"id="packNum"> 
                        <?php
                        $num =0;
                    ...
                    <a href="shipping.php" class="btn btn-primary">Shipping<span style=" color: white; font-weight:600;"> 
                        <?php
                        $num =0;
                    ...
                    <a href="delivered.php" class="btn btn-success deliveredNotif">Delivered<span style="color: white; font-weight:600; " > 
                        <?php
                        $num =0;
                    ...
                    <a href="ReturnedOrders.php" class="btn btn-dark">Returned<span style="color: white; font-weight:600; " > 
                        <?php
                        $num =0;
  ...
  <div class="modal-dialog  modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <button type="button" class="btn btn-danger" onclick="deleteColor(); packNotif();" data-bs-dismiss="modal">Yes</button>
