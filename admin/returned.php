...
{
     $.ajax({
            url: "returnedNotif.php",
            type: "POST",
            
            
            success: function (response) {
                $("#returnNum").html(response);
