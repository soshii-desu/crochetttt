        ...
        <main>
            <div class="header">
                ...
                <div class="right">   
                    ...
                    <a href="shipping.php" class="btn ">Shipping
                    </a>
                    <a href="delivered.php" class="btn btn-success deliveredNotif">Delivered<span style="color: white; font-weight:600; " id="packNum"> 
                        <?php
                        $num =0;
                    ...
                    <a href="ReturnedOrders.php" class="btn btn-dark">Returned<span style="color: white; font-weight:600; " id="returnNum"> 
                        <?php
                        $num =0;
