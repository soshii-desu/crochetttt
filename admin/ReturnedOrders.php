        ...
        <main>
            <div class="header">
                ...
                <div class="right">   
                    ...
                    <a href="cancelledOrders.php" class="btn btn-danger">Cancelled<span style="color: white; font-weight:600"> 
                            <?php
                            $num =0;
                    ...
                    <a href="packing.php" class="btn btn-warning ">Packing<span style="color: white; font-weight:600"> 
                        <?php
                        $num =0;
                    ...
                    <a href="deliver.php" class="btn ">Returned</a>
           ...
           include "../connection.php";
            ...
            ?>
                <tr>
                   ...
                   <td>
                    <button class="btn btn-danger" onclick="deletereturn(<?=$row['ID']?>);" id="<?=$row['ID']?>">Delete</button>
                   </td>
