...
<?php
     ...
     if(isset($_POST['addProduct']))
    {
        ...
        $sql = "INSERT INTO `products`(`Photo`, `ProductName`, `Description`, `Price`, `Discount`, `Quantity`, `Color`, `Category`, `DateAdded`) VALUES ('$Photo', '$pName','$description','$Price','$Discount','$Quantity','$pColor','$pCategory','$addDate' )";
            ...
            <div class="addForm">
                <form action=""  method="POST"  enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <input required type="text" name="pName" class="form-control">                        
                    </div>
                    ...
                    <div>
                        ...
                        <input required type="number" value="0" name="Discount" class="form-control" placeholder="Leave if none">    
                    </div>
                    ...
                    <div></div>
                    <div class="d-flex">
                    <button type="submit" name="addProduct" class="btn btn-success w-25 p-1 me-2">Add Product</button>
